...
CMDs[#CMDs + 1] = {NAME = 'forsaken / fsak', DESC = 'Opens Script Forsaken'}
CMDs[#CMDs + 1] = {NAME = 'murdermustery2 / mm2', DESC = 'Opens Script for MM2'}
...
addcmd("murdermustery2", {"mm2"}, function(args, speaker)
	notify("Loading", "MM2 Script")
end)

addcmd("forsaken", {"fsak"}, function(args, speaker)
	notify("Loading", "Forsaken script")
